...
Environment Variables:
    ...
    MCP_PORT: Port for HTTP/SSE. Default: 11113 (fleet 10700+; set MCP_PORT to override)
...
""",
    ...
    parser.add_argument("--port", type=int, default=None, help=f"Port to listen on (default: ${ENV_PORT} or 11113)")
